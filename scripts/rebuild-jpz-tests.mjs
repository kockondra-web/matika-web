...
const tests = {
  ...
  b: [
    ...
    task('10','Konstrukce',3,'Je dána úsečka AB = 6 cm a úhel α = 55°. Sestrojte všechny trojúhelníky ABC, pro které AC = 5 cm a velikost úhlu ABC je α.','V bodě B sestrojte rameno úhlu 55° a protněte je kružnicí se středem A a poloměrem 5 cm; zvažte obě poloroviny.',[],{manual:true,rubric:'3 body za přesnou konstrukci všech řešení, 2 body za jedno správné řešení, 1 bod za správně sestrojený úhel nebo kružnici.'}),
...
const visuals = {
  a: {
    8: `<svg class="task-figure jpz-visual" viewBox="0 0 520 260" role="img" aria-label="Obdélník s kratší stranou 5 centimetrů a úhlopříčkou 13 centimetrů"><rect class="shape" x="75" y="45" width="360" height="150"/><line class="guide" x1="75" y1="195" x2="435" y2="45"/><text x="42" y="125">5 cm</text><text x="245" y="105">13 cm</text><text x="245" y="225">?</text></svg>`,
    11: `<div class="jpz-table-wrap"><table class="jpz-data-table"><caption>Počet výpůjček v knihovně</caption><thead><tr><th>Týden</th><th>1.</th><th>2.</th><th>3.</th><th>4.</th></tr></thead><tbody><tr><th>Výpůjčky</th><td>120</td><td>150</td><td>90</td><td>180</td></tr></tbody></table></div>`
  },
  b: {
    8: `<svg class="task-figure jpz-visual" viewBox="0 0 520 270" role="img" aria-label="Lichoběžník se základnami 10 a 18 centimetrů a výškou 6 centimetrů"><polygon class="shape" points="85,205 435,205 355,70 165,70"/><line class="guide" x1="165" y1="70" x2="165" y2="205"/><text x="245" y="55">10 cm</text><text x="245" y="235">18 cm</text><text x="105" y="145">6 cm</text></svg>`,
    11: `<div class="jpz-table-wrap"><table class="jpz-data-table"><caption>Teplota ve čtyřech dnech</caption><thead><tr><th>Den</th><th>1.</th><th>2.</th><th>3.</th><th>4.</th></tr></thead><tbody><tr><th>Teplota</th><td>12 °C</td><td>16 °C</td><td>14 °C</td><td>18 °C</td></tr></tbody></table></div>`
  },
  c: {
    8: `<svg class="task-figure jpz-visual" viewBox="0 0 520 300" role="img" aria-label="Pravidelný šestiúhelník se stranou 6 centimetrů a apotémou 5,2 centimetru"><polygon class="shape" points="170,55 350,55 445,150 350,245 170,245 75,150"/><line class="guide" x1="260" y1="150" x2="260" y2="55"/><circle cx="260" cy="150" r="4" fill="currentColor"/><text x="270" y="105">5,2 cm</text><text x="245" y="42">6 cm</text></svg>`,
    11: `<div class="jpz-table-wrap"><table class="jpz-data-table"><caption>Počty návštěvníků</caption><thead><tr><th>Období</th><th>1.</th><th>2.</th><th>3.</th><th>4.</th></tr></thead><tbody><tr><th>Návštěvníci</th><td>24</td><td>30</td><td>18</td><td>36</td></tr></tbody></table></div>`
  },
  d: {
    8: `<svg class="task-figure jpz-visual" viewBox="0 0 520 290" role="img" aria-label="Trojúhelník se stranami 13, 14 a 15 centimetrů"><polygon class="shape" points="75,225 445,225 285,55"/><text x="250" y="255">14 cm</text><text x="145" y="135">13 cm</text><text x="360" y="135">15 cm</text></svg>`,
    11: `<div class="jpz-table-wrap"><table class="jpz-data-table"><caption>Prodej ve čtyřech obdobích</caption><thead><tr><th>Období</th><th>1.</th><th>2.</th><th>3.</th><th>4.</th></tr></thead><tbody><tr><th>Prodané kusy</th><td>80</td><td>120</td><td>100</td><td>140</td></tr></tbody></table></div>`
  }
};

for (const [variant, byTask] of Object.entries(visuals)) {
  for (const [number, visual] of Object.entries(byTask)) tests[variant][Number(number) - 1].visual = visual;
}
